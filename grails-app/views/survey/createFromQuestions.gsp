...
<div id="create-survey">
    <g:form action="saveFromQuestions" class="ui form" role="form">
        ...
        <div class="field">
            ...
            <g:select class="ui search dropdown" optionKey="id" optionValue="category" from="${valueme.Category.findAllByTypeAndParentIsNotNull(valueme.Param.findByName('survey.categoryType')?.value)}" value="${survey.category}" name="survey.category"/>
        </div>
        <!-- List of questions -->
