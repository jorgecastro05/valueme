            ...
            <div class="ui basic segment">
                ...
                <div class="inline field">
                    <div class="ui checkbox">
                        <input type="checkbox" name="${rememberMeParameter ?: 'remember-me'}" id="remember_me" <g:if
                ...
                <input class="ui blue fluid button" type="submit" id="submit"
                    value="${message(code: 'springSecurity.login.button')}" />
            </div>
        </g:form>
        <g:link class="ui basic button" controller="UserAccount" action="forgetPassword">
