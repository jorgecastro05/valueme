...
class PermissionController {
    ...
    def save(Permission permission) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'permission.label', default: 'Permission'), permission.permission])
                redirect permission
            }
    ...
    def edit(Permission permission) {
        [permission:permission, oldPermission:permission.permission]
    }
    ...
    def update(Permission permission) {
        ...
        // edit all roles with permission
        


        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'permission.label', default: 'Permission'), permission.permission])
                redirect permission
            }
    ...
    def delete(Permission permission) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'permission.label', default: 'Permission'), permission.permission])
